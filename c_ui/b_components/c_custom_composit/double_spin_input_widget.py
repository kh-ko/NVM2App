from c_ui.b_components.a_custom_base.custom_doublespinbox import CustomDoubleSpinBox
from PySide6.QtCore import Qt
from PySide6.QtWidgets import QWidget, QHBoxLayout

from c_ui.b_components.a_custom_base.custom_label import CustomLabel
class DoubleSpinInputWidget(QWidget):
    def __init__(self, label_text="", label_width=150, parent=None):
        ...
        # 3. 라인 에디트 생성 및 추가
        self.line_edit = CustomDoubleSpinBox()
