...
from PySide6.QtWidgets import QWidget, QHBoxLayout, QLabel, QDoubleSpinBox, QGraphicsOpacityEffect
...
class CustomDoubleSpinBox(QWidget):
    ...
    def setValue(self, val: float):
        ...
        # 🟢 3. 코드로 값을 바꿀 때는 시그널 발생을 완벽하게 차단!
        self.line_edit.blockSignals(True)
        self.line_edit.setValue(val)
        self.line_edit.blockSignals(False) # 세팅 완료 후 다시 차단 해제
    ...
    def _on_text_edited(self, current_value: float):
        ...
        is_dirty = (current_value != self._original_value)
