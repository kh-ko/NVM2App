from c_ui.b_control_packet.controls.my_value_label_number import MyValueLabelNumber
from c_ui.b_control_packet.controls_with_label.l_base_ro_widget import LBaseReadOnlyWidget

class LNumberReadOnlyWidget(LBaseReadOnlyWidget):
    def __init__(self, label_text="", label_width=150, parent=None):
        ...
        self.value_widget = MyValueLabelNumber()
