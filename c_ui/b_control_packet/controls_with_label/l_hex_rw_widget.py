...
from c_ui.b_control_packet.controls.my_value_input_hex import MyValueInputHex
from c_ui.b_control_packet.controls_with_label.l_base_rw_widget import LBaseReadWriteWidget

class LHexReadWriteWidget(LBaseReadWriteWidget):    
    def __init__(self, label_text="", label_width=150, parent=None):
        ...
        self.value_widget = MyValueInputHex()
