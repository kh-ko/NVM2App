...
class SysIdentificationWin(ParamBaseWin):
    """
    ...
    def __init__(self, parent=None):
        ...
        folder_widget = ParamFolderWidget(folder_name="System.Identification")
        ...
        folder_widget = ParamFolderWidget(folder_name="System.Identification.Configuration")

        params = self.param_manager.get_params_in_folder(folder_widget.folder_name)

        for param in params:
            self.param_worker.add_write_param_ptr(param)
            folder_widget.add_param(param)

        self.parameter_folder_widgets.append(folder_widget)
        self.content_layout.addWidget(folder_widget)

        folder_widget = ParamFolderWidget(folder_name="System.Identification.Fimeware")
